...
describe('StabilityPool - withdrawFromSP reward calculations', async () => {
  let
  ...
  describe("Stability Pool Withdrawal", async () => {
    ...
    beforeEach(async () => {
      ...
      [ defaulter_1, defaulter_2, defaulter_3, defaulter_4, defaulter_5] = [F, E, C, D, I];
      [ flyn, graham, harriet, ida, freddy, greta, harry] = [A, B, H, D, G, C, E]
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await contracts.wstETHMock.connect(whale).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(whale).openTrove(dec(100000, 'ether'), th._100pct, await getOpenTroveLUSDAmount(toBN(dec(100000, 18))), whale.address, whale.address)
      ...
      await contracts.wstETHMock.connect(defaulter_1).approve(borrowerOperations.address, dec(100000, 'ether'))
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(alice.address), toBN('6666666666666666666666')), 10000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), toBN('6666666666666666666666')), 10000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), toBN('6666666666666666666666')), 10000)

      assert.isAtMost(th.getDifference(alice_ETHWithdrawn, toBN('33166666666666666667')), 10000)
      assert.isAtMost(th.getDifference(bob_ETHWithdrawn, toBN('33166666666666666667')), 10000)
      assert.isAtMost(th.getDifference(carol_ETHWithdrawn, toBN('33166666666666666667')), 10000)
    })
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
      ...
      await contracts.wstETHMock.connect(defaulter_1).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_1).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount(toBN(dec(10000, 18))), defaulter_1.address, defaulter_1.address)
      await contracts.wstETHMock.connect(defaulter_2).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_2).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount(toBN(dec(10000, 18))), defaulter_2.address, defaulter_2.address)
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(alice.address), toBN('3333333333333333333333')), 10000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), toBN('3333333333333333333333')), 10000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), toBN('3333333333333333333333')), 10000)

      assert.isAtMost(th.getDifference(alice_ETHWithdrawn, toBN('66333333333333333333')), 10000)
      assert.isAtMost(th.getDifference(bob_ETHWithdrawn, toBN('66333333333333333333')), 10000)
      assert.isAtMost(th.getDifference(carol_ETHWithdrawn, toBN('66333333333333333333')), 10000)
    })
    ...
    it("withdrawFromSP():  Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three identical liquidations", async () => {
      ...
      await contracts.wstETHMock.connect(defaulter_2).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_2).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount(toBN(dec(10000, 18))), defaulter_2.address, defaulter_2.address)
      await contracts.wstETHMock.connect(defaulter_3).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_3).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount(toBN(dec(10000, 18))), defaulter_3.address, defaulter_3.address)
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(alice.address), toBN('0')), 10000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), toBN('0')), 10000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), toBN('0')), 10000)

      assert.isAtMost(th.getDifference(alice_ETHWithdrawn, toBN(dec(99500, 15))), 10000)
      assert.isAtMost(th.getDifference(bob_ETHWithdrawn, toBN(dec(99500, 15))), 10000)
      assert.isAtMost(th.getDifference(carol_ETHWithdrawn, toBN(dec(99500, 15))), 10000)
    })
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two liquidations of increasing LUSD", async () => {
      ...
      // Defaulters open trove with 200% ICR
      await contracts.wstETHMock.connect(defaulter_1).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_1).openTrove('50000000000000000000', th._100pct, await getOpenTroveLUSDAmount(toBN(dec(5000, 18))), defaulter_1.address, defaulter_1.address)
      await contracts.wstETHMock.connect(defaulter_2).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_2).openTrove('70000000000000000000', th._100pct, await getOpenTroveLUSDAmount(toBN(dec(7000, 18))), defaulter_2.address, defaulter_2.address)
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(alice.address), toBN('6000000000000000000000')), 10000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), toBN('6000000000000000000000')), 10000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), toBN('6000000000000000000000')), 10000)

      // (0.5 + 0.7) * 99.5 / 3
      assert.isAtMost(th.getDifference(alice_ETHWithdrawn, toBN(dec(398, 17))), 10000)
      assert.isAtMost(th.getDifference(bob_ETHWithdrawn, toBN(dec(398, 17))), 10000)
      assert.isAtMost(th.getDifference(carol_ETHWithdrawn, toBN(dec(398, 17))), 10000)
    })
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three liquidations of increasing LUSD", async () => {
      ...
      await borrowerOperations.connect(defaulter_1).openTrove('50000000000000000000', th._100pct, await getOpenTroveLUSDAmount(toBN(dec(5000, 18))), defaulter_1.address, defaulter_1.address)
      await contracts.wstETHMock.connect(defaulter_2).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_2).openTrove('60000000000000000000', th._100pct, await getOpenTroveLUSDAmount(toBN(dec(6000, 18))), defaulter_2.address, defaulter_2.address)
      await contracts.wstETHMock.connect(defaulter_3).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_3).openTrove('70000000000000000000', th._100pct, await getOpenTroveLUSDAmount(toBN(dec(7000, 18))), defaulter_3.address, defaulter_3.address)
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(alice.address), toBN('4000000000000000000000')), 10000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), toBN('4000000000000000000000')), 10000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), toBN('4000000000000000000000')), 10000)

      // (0.5 + 0.6 + 0.7) * 99.5 / 3
      assert.isAtMost(th.getDifference(alice_ETHWithdrawn, toBN(dec(597, 17))), 10000)
      assert.isAtMost(th.getDifference(bob_ETHWithdrawn, toBN(dec(597, 17))), 10000)
      assert.isAtMost(th.getDifference(carol_ETHWithdrawn, toBN(dec(597, 17))), 10000)
    })
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(alice.address), toBN('6666666666666666666666')), 100000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), toBN('13333333333333333333333')), 100000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), toBN('20000000000000000000000')), 100000)

      assert.isAtMost(th.getDifference(alice_ETHWithdrawn, toBN('33166666666666666667')), 100000)
      assert.isAtMost(th.getDifference(bob_ETHWithdrawn, toBN('66333333333333333333')), 100000)
      assert.isAtMost(th.getDifference(carol_ETHWithdrawn, toBN(dec(995, 17))), 100000)
    })
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three identical liquidations", async () => {
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(alice.address), toBN('5000000000000000000000')), 100000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), toBN('10000000000000000000000')), 100000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), toBN('15000000000000000000000')), 100000)
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three varying liquidations", async () => {
      ...
      await contracts.wstETHMock.connect(whale).approve(borrowerOperations.address, dec(1000000, 'ether'))
      ...
      */
      ...
      // ()
      assert.isAtMost(th.getDifference(await simToken.balanceOf(alice.address), '901719380174061000000'), 100000000000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), '205592018679686000000000'), 10000000000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), '5906261940140100000000'), 10000000000)
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 1 liquidation. All deposits and liquidations = 100 LUSD.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      console.log()
      assert.isAtMost(th.getDifference(await simToken.balanceOf(alice.address), '1666666666666666666666'), 100000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), '1666666666666666666666'), 100000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), '1666666666666666666666'), 100000)

      assert.isAtMost(th.getDifference((await simToken.balanceOf(dennis.address)).toString(), '5000000000000000000000'), 100000)
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. All deposits and liquidations = 100 LUSD.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      await contracts.wstETHMock.connect(defaulter_3).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_3).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount(toBN(dec(10000, 18))), defaulter_3.address, defaulter_3.address)
      await contracts.wstETHMock.connect(defaulter_4).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_4).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount(dec(10000, 18)), defaulter_4.address, defaulter_4.address)
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(alice.address), '0'), 100000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), '0'), 100000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), '0'), 100000)
      assert.isAtMost(th.getDifference((await simToken.balanceOf(dennis.address)).toString(), '0'), 100000)
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. Various deposit and liquidation vals.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      */
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(alice.address), '17832817337461300000000'), 100000000000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), '5944272445820430000000'), 100000000000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), '4458204334365320000000'), 100000000000)
      assert.isAtMost(th.getDifference((await simToken.balanceOf(dennis.address)).toString(), '11764705882352900000000'), 100000000000)
    ...
    it("withdrawFromSP(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. All deposits and liquidations = 100 LUSD.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(alice.address), '0'), 1000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), '0'), 1000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), '0'), 1000)
    ...
    it("withdrawFromSP(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. Various deposit and liquidation vals. A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      */
      ...
      await borrowerOperations.connect(defaulter_1).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount(toBN(dec(10000, 18))), defaulter_1.address, defaulter_1.address)
      await contracts.wstETHMock.connect(defaulter_2).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_2).openTrove(dec(200, 'ether'), th._100pct, await getOpenTroveLUSDAmount(dec(20000, 18)), defaulter_2.address, defaulter_2.address)
      await contracts.wstETHMock.connect(defaulter_3).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_3).openTrove(dec(300, 'ether'), th._100pct, await getOpenTroveLUSDAmount(dec(30000, 18)), defaulter_3.address, defaulter_3.address)
      await contracts.wstETHMock.connect(defaulter_4).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_4).openTrove('50000000000000000000', th._100pct, await getOpenTroveLUSDAmount(dec(5000, 18)), defaulter_4.address, defaulter_4.address)
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(alice.address), '1672240802675590000000'), 10000000000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), '2090301003344480000000'), 100000000000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), '1045150501672240000000'), 100000000000)
    ...
    it("withdrawFromSP(): A, B, D deposit -> 2 liquidations -> C makes deposit -> 1 liquidation -> D withdraws -> 1 liquidation. All deposits: 100 LUSD. Liquidations: 100,100,100,50.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(alice.address), '666666666666666666666'), 100000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), '666666666666666666666'), 100000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), '2000000000000000000000'), 100000)
    ...
    it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      // 2 Defaulters open trove with 200% ICR
      await contracts.wstETHMock.connect(defaulter_1).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_1).openTrove(dec(200, 'ether'), th._100pct, await getOpenTroveLUSDAmount(dec(20000, 18)), defaulter_1.address, defaulter_1.address)
      await contracts.wstETHMock.connect(defaulter_2).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_2).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount(toBN(dec(10000, 18))), defaulter_2.address, defaulter_2.address)
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), '5000000000000000000000'), 100000)
      assert.isAtMost(th.getDifference((await simToken.balanceOf(dennis.address)).toString(), '5000000000000000000000'), 100000)
    ...
    it("withdrawFromSP(): Depositors withdraw correct compounded deposit after liquidation empties the pool", async () => {
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), '8333333333333333333333'), 100000)
      assert.isAtMost(th.getDifference((await simToken.balanceOf(dennis.address)).toString(), '16666666666666666666666'), 100000)
      assert.isAtMost(th.getDifference((await simToken.balanceOf(erin.address)).toString(), '25000000000000000000000'), 100000)
      ...
      assert.isAtMost(th.getDifference(dennis_ETHWithdrawn, toBN('33166666666666666667')), 100000)
    ...
    it("withdrawFromSP(): single deposit fully offset. After subsequent liquidations, depositor withdraws 0 deposit and *only* the ETH Gain from one liquidation", async () => {
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(alice.address), toBN('0')), 100000)
      assert.isAtMost(th.getDifference(alice_ETHWithdrawn, dec(995, 17)), 100000)
    })
    ...
    it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      await borrowerOperations.connect(defaulter_2).openTrove(dec(200, 'ether'), th._100pct, await getOpenTroveLUSDAmount(dec(20000, 18)), defaulter_2.address, defaulter_2.address)
      await contracts.wstETHMock.connect(defaulter_3).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_3).openTrove(dec(200, 'ether'), th._100pct, await getOpenTroveLUSDAmount(dec(20000, 18)), defaulter_3.address, defaulter_3.address)
      await contracts.wstETHMock.connect(defaulter_4).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_4).openTrove(dec(200, 'ether'), th._100pct, await getOpenTroveLUSDAmount(dec(20000, 18)), defaulter_4.address, defaulter_4.address)
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), '0'), 100000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), '0'), 100000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(dennis.address), '0'), 100000)
      assert.isAtMost(th.getDifference((await simToken.balanceOf(erin.address)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await simToken.balanceOf(flyn.address)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await simToken.balanceOf(graham.address)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await simToken.balanceOf(harriet.address)).toString(), '0'), 100000)
    ...
    it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await contracts.wstETHMock.connect(defaulter_1).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_1).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount('9999999910000000000000'), defaulter_1.address, defaulter_1.address)

      assert.equal((await stabilityPool.currentScale()).toString(), '0')

      // Defaulter 2 withdraws 9900 LUSD
      await contracts.wstETHMock.connect(defaulter_2).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_2).openTrove(dec(60, 'ether'), th._100pct, await getOpenTroveLUSDAmount(dec(9900, 18)), defaulter_2.address, defaulter_2.address)
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), '100000000000000000000'), 100000)
    ...
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await contracts.wstETHMock.connect(defaulter_2).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_2).openTrove(dec(330, 'ether'), th._100pct, await getOpenTroveLUSDAmount('59400000000000000000000'), defaulter_2.address, defaulter_2.address)
      ...
      */
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), dec(100, 18)), 100000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), dec(200, 18)), 100000)
      assert.isAtMost(th.getDifference((await simToken.balanceOf(dennis.address)).toString(), dec(300, 18)), 100000)
    ...
    it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await contracts.wstETHMock.connect(defaulter_1).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_1).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount(dec(99999, 17)), defaulter_1.address, defaulter_1.address)
      await contracts.wstETHMock.connect(defaulter_2).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_2).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount(dec(99999, 17)), defaulter_2.address, defaulter_2.address)
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), dec(1, 17)), 100000)
    ...
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await contracts.wstETHMock.connect(defaulter_1).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_1).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount('9999900000000000000000'), defaulter_1.address, defaulter_1.address)
      await contracts.wstETHMock.connect(defaulter_2).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_2).openTrove(dec(600, 'ether'), th._100pct, await getOpenTroveLUSDAmount('59999400000000000000000'), defaulter_2.address, defaulter_2.address)
      ...
      assert.isAtMost(th.getDifference(await simToken.balanceOf(bob.address), dec(1, 17)), 100000)
      assert.isAtMost(th.getDifference(await simToken.balanceOf(carol.address), dec(2, 17)), 100000)
      assert.isAtMost(th.getDifference((await simToken.balanceOf(dennis.address)).toString(), dec(3, 17)), 100000)
    ...
    it("withdrawFromSP(): Deposit that decreases to less than 1e-9 of it's original value is reduced to 0", async () => {
      ...
      await contracts.wstETHMock.connect(defaulter_1).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_1).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount('9999999999900000000000'), defaulter_1.address, defaulter_1.address)
    ...
    */
    it("withdrawFromSP(): Several deposits of 10000 LUSD span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await borrowerOperations.connect(defaulter_1).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount('9999900000000000000000'), defaulter_1.address, defaulter_1.address)
      await contracts.wstETHMock.connect(defaulter_2).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_2).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount('9999900000000000000000'), defaulter_2.address, defaulter_2.address)
      await contracts.wstETHMock.connect(defaulter_3).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_3).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount('9999900000000000000000'), defaulter_3.address, defaulter_3.address)
      await contracts.wstETHMock.connect(defaulter_4).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_4).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount('9999900000000000000000'), defaulter_4.address, defaulter_4.address)
      ...
      assert.equal((await simToken.balanceOf(alice.address)).toString(), '0')
      assert.equal((await simToken.balanceOf(alice.address)).toString(), '0')
      assert.equal((await simToken.balanceOf(alice.address)).toString(), '0')
      // D should withdraw around 0.9999 LUSD, since his deposit of 9999.9 was reduced by a factor of 1e-5
      assert.isAtMost(th.getDifference((await simToken.balanceOf(dennis.address)).toString(), dec(99999, 12)), 100000)
    ...
    it("withdrawFromSP(): 2 depositors can withdraw after each receiving half of a pool-emptying liquidation", async () => {
      ...
      await contracts.wstETHMock.connect(defaulter_1).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_1).openTrove(dec(200, 'ether'), th._100pct, await getOpenTroveLUSDAmount(dec(24100, 18)), defaulter_1.address, defaulter_1.address)
      await contracts.wstETHMock.connect(defaulter_2).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_2).openTrove(dec(200, 'ether'), th._100pct, await getOpenTroveLUSDAmount(dec(24300, 18)), defaulter_2.address, defaulter_2.address)
      await contracts.wstETHMock.connect(defaulter_3).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_3).openTrove(dec(200, 'ether'), th._100pct, await getOpenTroveLUSDAmount(dec(24500, 18)), defaulter_3.address, defaulter_3.address)
    ...
    it("withdrawFromSP(): Depositor's ETH gain stops increasing after two scale changes", async () => {
      ...
      await borrowerOperations.connect(defaulter_2).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount(dec(99999, 17)), defaulter_2.address, defaulter_2.address)
      await contracts.wstETHMock.connect(defaulter_3).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_3).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount(dec(99999, 17)), defaulter_3.address, defaulter_3.address)
      await contracts.wstETHMock.connect(defaulter_4).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_4).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount(dec(99999, 17)), defaulter_4.address, defaulter_4.address)
      await contracts.wstETHMock.connect(defaulter_5).approve(borrowerOperations.address, dec(100000, 'ether'))
      await borrowerOperations.connect(defaulter_5).openTrove(dec(100, 'ether'), th._100pct, await getOpenTroveLUSDAmount(dec(99999, 17)), defaulter_5.address, defaulter_5.address)
      ...
      const alice_ETHGainAt2ndScaleChange = (await stabilityPool.getDepositorWSTETHGain(alice.address)).toString()

      // E deposits 9999.9 LUSD
      await simToken.connect(whale).transfer(erin.address, dec(99999, 17))
      ...
      assert.equal((await stabilityPool.P()).toString(), dec(1, 11)) // P decreases to 1e(16-5) = 1e11
      assert.equal((await stabilityPool.currentScale()).toString(), '2')

      const alice_ETHGainAfterFurtherLiquidation = (await stabilityPool.getDepositorWSTETHGain(alice.address)).toString()
  
      const alice_scaleSnapshot = (await stabilityPool.depositSnapshots(alice.address))[2].toString()
    ...
    it("withdrawFromSP(): Large liquidated coll/debt, deposits and ETH price", async () => {
      ...
      await contracts.wstETHMock.connect(defaulter_1).approve(borrowerOperations.address, dec(1, 27))
      ...
      const bobLUSDBalance = await simToken.balanceOf(bob.address)
    ...
    it("withdrawFromSP(): Small liquidated coll/debt, large deposits and ETH price", async () => {
      ...
      const depositors = [alice, bob]
      for (const account of depositors) {
        await contracts.wstETHMock.connect(account).approve(borrowerOperations.address, dec(1, 38))
